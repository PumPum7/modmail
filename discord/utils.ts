...
export function categorizeAttachments(attachments: Attachment[]) {
	...
	const nonImageAttachments = attachments.filter((att) => !att.content_type?.startsWith('image/'));
